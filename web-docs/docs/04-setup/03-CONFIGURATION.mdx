...
If no configuration file is detected, a default configuration file will be generated to match what shows below:
...
:::note
The value of -1 indicates that data aggregation is disabled.
:::
...
:::note
It is recommended to use the device name as the ApiClientId.
:::
